...
const LEGACY_STORAGE_KEY = "tools:blake3-hash-text-or-file:text";
...
function Blake3HashTextOrFilePageContent() {
  ...
  return (
    <ToolPanelCard>
      <Card.Header className="border-b border-separator">
        <Card.Title>
          {m["shared.blakeHash.blake3ConfigurationLabel"]()}
        </Card.Title>
      </Card.Header>
      <ToolPanelCardContent className="grid gap-6 py-4">
        ...
        <div className="grid gap-2">
          <Label htmlFor={keyInputId}>
            {m["shared.blakeHash.blake3KeyLabel"]()}
          </Label>
          <Input
            id={keyInputId}
            aria-label={m["shared.blakeHash.blake3KeyLabel"]()}
            placeholder={m["shared.blakeHash.blake3KeyPlaceholder"]()}
            autoComplete="off"
            spellCheck={false}
            value={keyBase64}
...
function BlakeArticle() {
  ...
  return (
    <ToolArticle>
      <h2>{m["shared.blakeHash.blake3ArticleTitle"]()}</h2>
      <p>{m["shared.blakeHash.blake3ArticleSummary"]()}</p>
      <p>
        <strong>
      ...
      <ul>
        <li>
          <strong>
            {m["shared.blakeHash.blake3ArticleCharacteristics0Title"]()}
          </strong>
          {separator}
          {m["shared.blakeHash.blake3ArticleCharacteristics0Body"]()}
        </li>
        <li>
          <strong>
          ...
          {separator}
          {m["shared.blakeHash.blake3ArticleCharacteristics1Body"]()}
        </li>
        <li>
          <strong>
          ...
          {separator}
          {m["shared.blakeHash.blake3ArticleCharacteristics2Body"]()}
        </li>
        <li>
          <strong>
        ...
        <li>
          ...
          {separator}
          {m["shared.blakeHash.blake3ArticleCharacteristics4Body"]()}
        </li>
        <li>
          <strong>
          ...
          {separator}
          {m["shared.blakeHash.blake3ArticleCharacteristics5Body"]()}
        </li>
        <li>
          <strong>
          ...
          {separator}
          {m["shared.blakeHash.blake3ArticleCharacteristics6Body"]()}
        </li>
        <li>
          <strong>
            {m["shared.blakeHash.blake3ArticleCharacteristics7Title"]()}
          </strong>
          {separator}
          {m["shared.blakeHash.blake3ArticleCharacteristics7Body"]()}
        </li>
      </ul>
      <p>
      ...
      <ul>
        ...
        <li>{m["shared.blakeHash.blake3ArticleCommonUses1"]()}</li>
...
export default function Blake3HashTextOrFilePage() {
  return (
    <ToolPage>
      <Blake3HashTextOrFilePageContent />
    </ToolPage>
  );
}
