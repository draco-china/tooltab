...
const LEGACY_STORAGE_KEY = "tools:blake2b-hash-text-or-file:text";
...
function Blake2bHashTextOrFilePageContent() {
  ...
  return (
    <ToolPanelCard>
      <Card.Header className="border-b border-separator">
        <Card.Title>
          {m["shared.blakeHash.blake2bConfigurationLabel"]()}
        </Card.Title>
      </Card.Header>
...
function BlakeArticle() {
  ...
  return (
    <ToolArticle>
      <h2>{m["shared.blakeHash.blake2bArticleTitle"]()}</h2>
      <p>{m["shared.blakeHash.blake2bArticleSummary"]()}</p>
      <p>
        <strong>
      ...
      <ul>
        <li>
          ...
          {separator}
          {m["shared.blakeHash.blake2bArticleCharacteristics0Body"]()}
        </li>
        <li>
          <strong>
      ...
      <ul>
        ...
        <li>{m["shared.blakeHash.blake2bArticleCommonUses4"]()}</li>
        ...
        : code === "read-failed"
          ...
          : code === "unsupported"
            ...
            : code === "invalid-key"
              ...
              : code === "invalid-length"
                ? m["shared.blakeHash.blake2bErrorInvalidLength"]()
...
export default function Blake2bHashTextOrFilePage() {
  return (
    <ToolPage>
      <Blake2bHashTextOrFilePageContent />
    </ToolPage>
  );
}
