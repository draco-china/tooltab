...
import { runSha1Worker, type ShaWorkerDigest } from "./worker-client";
...
export default function Sha1HashTextOrFile() {
  ...
  useEffect(() => {
    ...
    setState({ status: "loading" });
    void runSha1Worker(file ?? debouncedText, controller.signal)
      .then((digest) => {
  ...
  return (
    <>
      <div className="grid gap-6" data-tool-panels data-sha1-hash-page>
        <ToolPanelCard>
...
function Sha1Article() {
  ...
  return (
    <ToolArticle>
      <h2>{m["tools.sha1HashTextOrFile.article.title"]()}</h2>
      <p>{m["tools.sha1HashTextOrFile.article.summary"]()}</p>
      <p>
        <strong>
      ...
      <p>
        ⚠️{" "}
        <strong>
          {m["tools.sha1HashTextOrFile.article.securityStrong"]()}
        </strong>
        {m["tools.sha1HashTextOrFile.article.security"]()}
      </p>
      <p>
        <strong>{m["tools.sha1HashTextOrFile.article.usesTitle"]()}</strong>
      </p>
      <ul>
        <li>{m["tools.sha1HashTextOrFile.article.uses0"]()}</li>
        <li>{m["tools.sha1HashTextOrFile.article.uses1"]()}</li>
        <li>{m["tools.sha1HashTextOrFile.article.uses2"]()}</li>
        <li>{m["tools.md4HashTextOrFile.article.uses0"]()}</li>
        <li>{m["tools.sha1HashTextOrFile.article.uses4"]()}</li>
      </ul>
      <p>
        <strong>
      ...
      <ul>
        <li>{m["tools.md4HashTextOrFile.article.alternatives0"]()}</li>
        <li>{m["tools.md4HashTextOrFile.article.alternatives1"]()}</li>
      </ul>
    </ToolArticle>
  );
}
