...
function MurmurHash3X86128Content() {
  const locale = getLocale();
  const fileError = m["tools.murmurhash3X86128HashTextOrFile.localFileError"]();
  const textError = m["tools.murmurhash3X86128HashTextOrFile.localTextError"]();
  const seedInvalid = m["shared.cityHighway.cityHash64SeedInvalid"]();
  const textId = useId();
  const seedId = useId();
  ...
  }, [fileError, textError, seedInvalid, file, seed, text]);
  ...
  return (
    <>
      ...
      <ToolArticle>
        <h2>{m["tools.murmurhash3X86128HashTextOrFile.article.title"]()}</h2>
        <p>{m["tools.murmurhash3X86128HashTextOrFile.article.summary"]()}</p>
        <p>
          <strong>
        ...
        <p>
          <InlineCodeText
            text={m["tools.murmurhash3X86128HashTextOrFile.article.seed"]()}
          />
        </p>
        <p>
          <strong>
...
export default function MurmurHash3X86128() {
  return (
    <ToolPage>
      <MurmurHash3X86128Content />
    </ToolPage>
  );
}
